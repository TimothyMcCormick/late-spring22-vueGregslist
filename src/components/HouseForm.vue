<template>
  <form class="row" action="">
    ...
    <div class="col-6">
      ...
      <button v-else type="button" class="m-2 btn btn-primary" @click="createHouse">
        Create
      </button>
    </div>
  </form>
    ...
    return {
      ...
      async editHouse() {
        try {
          ...
          Modal.getOrCreateInstance(document.getElementById("edit-house" + houseData.value.id)).hide();
